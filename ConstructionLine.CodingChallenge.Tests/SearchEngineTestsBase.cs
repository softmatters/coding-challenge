            ...
            foreach (var size in Size.All)
            {
                ...
                var expectedSizeCount = shirts
                    .Count(shirt =>
                        ...
                        (searchOptions.Sizes.Count == 0 || searchOptions.Sizes.Select(s => s.Id).Contains(shirt.Size.Id)) &&
                        (searchOptions.Colors.Count == 0 || searchOptions.Colors.Select(color => color.Id).Contains(shirt.Color.Id)));
            ...
            foreach (var color in Color.All)
            {
                ...
                var expectedColorCount = shirts
                    .Count(shirt =>
                        ...
                        (searchOptions.Sizes.Count == 0 || searchOptions.Sizes.Select(size => size.Id).Contains(shirt.Size.Id)) &&
                        (searchOptions.Colors.Count == 0 || searchOptions.Colors.Select(c => c.Id).Contains(shirt.Color.Id)));
